...
|---|---:|---|
| UTF-8 bytes | 9,293 | `Buffer.byteLength(source)` |
| Unicode code points | 9,223 | `[...source].length` |
| source tokens | 1,650 | non-whitespace runs, `/\S+/gu` |
...
```text
{ bytes: 9293, codePoints: 9223, sourceTokens: 1650, sourceHeadings: 15 }
```
