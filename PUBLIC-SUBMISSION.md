...
|---|---:|---|
| UTF-8 bytes | 8,851 | `Buffer.byteLength(source)` |
| Unicode code points | 8,785 | `[...source].length` |
| source tokens | 1,574 | non-whitespace runs, `/\S+/gu` |
...
```text
{ bytes: 8851, codePoints: 8785, sourceTokens: 1574, sourceHeadings: 15 }
```
